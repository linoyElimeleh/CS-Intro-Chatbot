...
public class List {
    ...
    public void add(int i, int val) {
        ...
        Node newNode = new Node(val);
        Node current = first;
        // Iterates to the location just before the insertion point
    ...
    /** If the given value is in the list, removes it and returns true.
    ...
    public boolean removeValue(int val) {
        ...
        // Removes the element. If it's the first element, update first
